/**
 * 自動安裝的實際流程可以參考 NsisUpdater().doInstall() 函式
 * https://github.com/electron-userland/electron-builder/blob/master/packages/electron-updater/src/NsisUpdater.ts#L89
 *
 * */
